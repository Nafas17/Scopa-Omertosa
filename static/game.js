...
async function loadState() {
    ...
    try {
        ...
        // Testo turno
        const isMyTurn = d.turn === (d.hand.length > 0 ? 0 : 1); // più sicuro
        document.getElementById("turn").innerText = d.turn === 0 ? "È il tuo turno" : "Turno avversario";
        ...
        d.hand.forEach((c,i)=>{
            ...
            img.src = cardImg(c);
            img.classList.add("card-img");
            if (d.turn === 0) img.addEventListener("click",()=>play(i));
